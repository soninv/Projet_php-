<template>
    <div class="container">
        <div class="row justify-content-center">
          <h1 class="display-3">Politics posts</h1>
          <router-link class="btn btn-info btn-create-post align-self-center"  to="/create/post/politics" exact>Create Post</router-link>
...
import getPostsMixin from '../mixins/getPostsMixin';
